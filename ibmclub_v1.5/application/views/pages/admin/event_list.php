                  ...
                  <div class="panel-body padding-30">
                    <table class="table table-bordered table-hover dataTable table-striped width-full" data-plugin="dataTable">
                      ...
                      <tbody>
                       ...
                       <tr>
                        <td style="font-weight:bold; color:black;"><?php echo $event->event_name; ?></td>
                        ...
                        <td><a href="<?php echo site_url('events/show_participants?id='.$event->event_id) ?>"><button type="button" class="btn btn-primary btn-sm">Katılanları Gör</button></a></td>
                        <td><a href="<?php echo site_url('events/edit_event?id='.$event->event_id) ?>"><button type="button" class="btn btn-warning btn-sm">Etkinliği Düzenle</button></a></td>
                        <td><a href="<?php echo site_url('events/cancel_event?id='.$event->event_id) ?>"><button type="button" class="btn btn-danger btn-sm">Etkinliği İptal Et</button></a></td>
                      </tr>
