                  ...
                  <div class="col-md-12 col-sm-6 col-xs-12">
                    <div class="panel panel-default">
                     ...
                     <div class="panel-body padding-30">
                      ...
                      <!--Event Name -->
                      <div class="form-group">
                        <label label-default="" class="col-md-2 control-label label-default">Etkinlik Adı:</label>
                        <div class="col-md-10">
                      ...
                      <!--Event Date -->
                      <div class="form-group">
                        <label label-default="" class="col-md-2 control-label label-default">Etkinlik Tarihi:</label>
                        <div class="col-md-10"> 
                     ...
                     <!--Event Place -->
                     <div class="form-group">
                      <label label-default="" class="col-md-2 control-label label-default">Etkinlik Yeri:</label>
                      <div class="col-md-10">
                    ...
                    <!--Event Quota -->
                    <div class="form-group">
                      <label label-default="" class="col-md-2 control-label label-default">Etkinlik Kotası:</label>
                      <div class="col-md-10">
                    ...
                    <!--Event Point -->
                    <div class="form-group">
                      <label label-default="" class="col-md-2 control-label label-default">Etkinlik Puanı:</label>
                      <div class="col-md-10">
                    ...
                    <!--Event Description -->
                    <div class="form-group">
                      <label label-default="" class="col-md-2 control-label label-default">Etkinlik Tanımı:</label>
                      <div class="col-md-10">
