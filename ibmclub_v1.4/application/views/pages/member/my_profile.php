              ...
              <div class="col-md-6 col-xs-12 masonry-item">
                <div class="widget">
                  <div class="widget-header white bg-cyan-600 padding-30 clearfix">
                    ...
                    <button type="button" class="btn btn-danger margin-bottom-5 text-nowrap"><span class="fa fa-gear"></span> Profil Düzenle </button>
                  ...
                  <div class="widget-content bg-white container-fluid">
                    <div class="row no-space padding-vertical-20 padding-horizontal-30 text-center">
                      <div class="col-xs-6">
                        <div class="counter">
                          <span class="counter-number">2</span> <!-- Database'den çekip yazacağız-->
                          <div class="counter-label">Katıldığım Etkinlikler</div>
                        </div>
                      </div>
                      <div class="col-xs-6">
                        <div class="counter">
                          <span style="color:yellow; font-size:18px; font-weight: bold;" class="counter-number">125</span> <!-- Database'den çekip yazacağız-->
