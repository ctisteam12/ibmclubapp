...
<head>
  ...
  <!-- Table için importlar-->

  <!-- HATA BURADA OLUYOR SANIRIM -->
      ...
      <div class="row" data-plugin="matchHeight" data-by-row="true">
        <div class="col-xlg-6 col-md-12">
          <div class="widget widget-shadow widget-responsive" id="widgetLineareaColor">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $event->event_quota; ?></td>
                      <td><?php echo $event->event_point; ?></td>
                      <td><?php echo $event->event_description; ?></td>
                      <td><button type="button" class="btn btn-primary btn-block"><span class="fa fa-gear"></span> KATIL </button></td>
                    </tr>
            ...
            <div>
              <p><?php echo $num_rows; ?> Etkinlik Listelendi.</p>
            </div>
