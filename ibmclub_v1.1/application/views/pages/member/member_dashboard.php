...
<div class="site-menubar">
  <div class="site-menubar-body">
    <div>
      <div>
        <ul class="site-menu">
          <li class="site-menu-category">Yan Menü</li>
          <li class="site-menu-item has-sub">
           ...
           <ul class="site-menu-sub">
            ...
            <li class="site-menu-item">
              <a class="animsition-link" href="<?php echo site_url('member/my_points') ?>" data-slug="dashboard-v1">
                <i class="site-menu-icon " aria-hidden="true"></i>
                <span class="site-menu-title">Puanlarım</span>
              </a>
            </li>
            <li class="site-menu-item">
        ...
        <li class="site-menu-item has-sub active open">
          ...
          <ul class="site-menu-sub">
            <li class="site-menu-item active">
              <a class="animsition-link" href="<?php echo site_url('member/member') ?>" data-slug="uikit-buttons">
                <i class="site-menu-icon " aria-hidden="true"></i>
      ...
      <a href="<?php echo site_url('pages/index') ?>" data-placement="top" data-toggle="tooltip" data-original-title="Logout">
