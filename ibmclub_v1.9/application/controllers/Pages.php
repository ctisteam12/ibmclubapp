<!-- 
	Bu Controller bizim Main controllerımız. Burada login ve session işlemlerini yapıyoruz. Bunun yanı sıra 
	URL işlemleri ve register işlemleri de burada gerçekleşiyor!
-->
	...
	public function login(){
		...
		else
		{
			...
			if($type == "user")
				...
				$ret = $this->admin_model->checkdatabase($email, $password);
