  ...
  <!--[if lt IE 8]>
                ...
                <div class="widget-content widget-radius text-center bg-white">
                  ...
                  <div class="panel panel-primary">
                    <header class="panel-heading">
                      ...
                      <h3 class="panel-title">Üye Listesi</h3>
                    </header>
                        ...
                        <tbody>
                          ...
                          foreach ($members as $member) {
                            ...
                            <tr>
                              ...
                              <td><a href="<?php echo site_url('admin/showmemberevents?id='.$member->id) ?>"><button type="button" class="btn btn-primary">Katıldığı Etkinlikleri Gör</button></a></td>
                              <td>
                                <button type="button" class="btn btn-danger my_button" data-target="#examplePositionSidebar" data-toggle="modal" id="<?php echo $member->id; ?>">Sil</button>
                              </td>
                              <td><a href="<?php echo site_url('admin/edit_member?id='.$member->id) ?>"><button type="button" class="btn btn-warning">Düzenle</button></a></td>
                              <td><a href="<?php echo site_url('admin/point_screen?id='.$member->id) ?>"><button type="button" class="btn btn-success">Puan Ekle/ Gör</button></a></td>
                            </tr>
                            <?php } ?>
                          </tbody>
                        </table>
                    ...
                    <div class="modal-dialog modal-sidebar modal-sm">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title">Bu üyeyi Silmek istediğinizden Emin misiniz?</h4>
                        </div>
                        <div class="modal-footer">
                         <a href="<?php echo site_url( ) ?>"><button type="button" class="btn btn-danger btn-block">Evet, Sil</button></a>
   ...
   (function(document, window, $) {
    ...
    $(".my_button").click(function(){
      $(".modal-footer a").attr("href", '../admin/deletemember?id='+$(this).attr('id'));
