                ...
                <div class="widget-content widget-radius text-center bg-white">
                  ...
                  <div class="panel panel-success">
                    <header class="panel-heading">
                      ...
                      <h3 class="panel-title">Etkinlik Listesi</h3>
                    </header>
                      ...
                      <table class="table table-bordered table-hover dataTable table-striped width-full" data-plugin="dataTable">
                        <thead>
                          <tr>
                            ...
                            <th>Katılanları Gör</th>
                            <th>Etkinliği Düzenle</th>
                            <th>Etkinliği İptal Et</th>
                          </tr>
                        </thead>
                        ...
                        <tbody>
                         ...
                         foreach($events as $event){ 
                          ...
                          <tr>
                            ...
                            <td><a href="<?php echo site_url('events/show_participants?id='.$event->event_id) ?>"><button type="button" class="animation-hover animation-scale btn btn-primary btn-sm">Katılanları Gör</button></a></td>
                            <td><a href="<?php echo site_url('events/edit_event?id='.$event->event_id) ?>"><button type="button" class="animation-hover animation-shake btn btn-warning btn-sm">Etkinliği Düzenle</button></a></td>
                            <td>
                              <button type="button" class="animation-hover animation-scale btn btn-danger btn-sm my_button" data-target="#examplePositionSidebar" data-toggle="modal" id="<?php echo $event->event_id; ?>">Etkinliği Kaldır</button>
                            </td>
                          </tr> 
                  ...
                  <div class="modal-dialog modal-sidebar modal-sm">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title">Bu etkinliği kaldırmak istediğinizden emin misiniz?</h4>
                      </div>
                      <div class="modal-footer">
                       <a href="<?php echo site_url( ) ?>"><button type="button" class="btn btn-danger btn-block">Evet, Kaldır</button></a>
                       <button type="button" class="btn btn-default btn-block" data-dismiss="modal">Vazgeç</button>
                     </div>
                   </div>
                 </div>
               </div>
 ...
 (function(document, window, $) {
  ...
  $(document).ready(function($) {
    ...
    $(".my_button").click(function(){
      $(".modal-footer a").attr("href", '../events/cancel_event?id='+$(this).attr('id'));
        //alert('admin/deletemember?id='+$(this).attr('id'));
      });
    </script>
