                ...
                <div class="widget-content widget-radius text-center bg-white">
                  ...
                  <div class="panel panel-primary">
                    <header class="panel-heading">
                      ...
                      ?>
                      <h3 class="panel-title"><?php echo $event_name; ?>Etkinliğine Katılanlar Listesi</h3>
                    </header>
                        ...
                        <tbody>
                          ...
                          foreach ($members as $member) {
                            ...
                            <tr>
                              ...
                              <td><?php echo $member->total-1 ?></td>

                              <td><a href="<?php echo site_url('events/show_participants_friend?id='.$member_id) ?>"><button type="button" class="animation-hover animation-scale btn btn-primary btn-sm">Yanında Katılanları Gör</button></a></td>
                            </tr>
                            <?php } ?>
                          </tbody>
                        </table>
