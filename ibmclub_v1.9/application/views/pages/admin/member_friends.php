...
<head>
  ...
  <title>Etkinliğe Katılanlar</title>
            ...
            <div class="widget widget-shadow widget-responsive" id="widgetLineareaColor">
              <div class="widget-content widget-radius text-center bg-white">
                ...
                foreach ($friends as $row) {
                  ...
                  $member_surname = $row->surname;
                }
                ?>
                <div class="panel panel-primary">
                  <header class="panel-heading">
                    <div class="panel-actions"></div>
                    <h3 class="panel-title"> Üyenin Yanında Katılanlar</h3>
                  </header>
                  <div class="panel-body padding-30">
                    <table class="table table-bordered table-hover dataTable table-striped width-full" data-plugin="dataTable">
                      ...
                      <tbody>
                       <?php 
                       foreach($friends as $row){ 
                        $friendname1 = $row->friendname1;
                        $friendname2 = $row->friendname2;
                        $friendname3 = $row->friendname3;
                        $friendsurname1 = $row->friendsurname1;
                        $friendsurname2 = $row->friendsurname2;
                        $friendsurname3 = $row->friendsurname3;
                        $friendemail1 = $row->friendemail1;
                        $friendemail2 = $row->friendemail2;
                        $friendemail3 = $row->friendemail3;
                        $friendtype1 = $row->friendtype1;
                        $friendtype2 = $row->friendtype2;
                        $friendtype3 = $row->friendtype3;
                      }
                      ?>
                      <?php 
                      for ($i=1; $i < 4; $i++) { 
                       ...
                       ?>
                       <tr>
                        <td style="font-weight:bold; color:black;"><?php echo ${"friendname".$i}; ?></td>
                        <td style="font-weight:bold; color:black;"><?php echo ${"friendsurname".$i}; ?></td>
                        <td style="font-weight:bold; color:black;"><?php echo ${"friendemail".$i}; ?></td>
                        <td style="font-weight:bold; color:black;"><?php echo ${"friendtype".$i}; ?></td>
                      </tr> 
                      <?php } ?>
                    </tbody>
                  </table>
