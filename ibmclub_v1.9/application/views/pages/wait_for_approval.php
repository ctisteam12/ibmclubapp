        ...
        <div class="page-content vertical-align-middle">
          <div class="example example-popover">
            ...
            <div class="popover top">
              <div class="arrow"></div>
              <h3 class="popover-title">Üyelik Başvurunuz Alınmıştır!</h3>
              <div class="popover-content">
                <p style="color:black";>Üyelik başvurunuz Admin onayından geçtikten sonra hesabınız aktif edilecektir! Hesabınız aktif edildikten sonra e-mail yolu ile bilgilendirileceksiniz.</p>
              </div>
            </div>
          </div>

          <p>Giriş Ekranına Dönmek için <a href="<?php echo site_url('pages/index') ?>">Tıklayınız</a></p>
        </div>
      </body>
      <!-- Footer Page -->
