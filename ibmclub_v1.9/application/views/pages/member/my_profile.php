                    ...
                    <div class="widget-header white bg-cyan-600 padding-30 clearfix">
                      <a class="avatar avatar-100 pull-left margin-right-20" href="javascript:void(0)">
                        ...
                        if($image == ""){
                          ...
                          ?>
                          <img src="<?php echo "../uploads/".$image; ?>" alt=""><!--../assets/images/ben.png-->
                        </a>
                        <div class="pull-left">
                          ...
                          <p class="margin-bottom-5 text-nowrap"><i class="icon wb-map margin-right-10" aria-hidden="true"></i>
                            <span
                            class="text-break"><?php echo $role;  ?></span>
                          </p>
                          ...
                          <a href="<?php echo site_url('member/edit_profile') ?>"><button type="button" class="btn btn-danger margin-bottom-5 text-nowrap"><span class="fa fa-gear"></span> Profil Düzenle </button></a>
                        </div>
                      </div>
