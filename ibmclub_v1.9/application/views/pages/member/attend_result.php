              ...
              <div class="widget widget-shadow widget-responsive" id="widgetLineareaColor">
                <div class="widget-content widget-radius text-center bg-white">
                  ...
                  foreach ($participants as $participant) {
                    $friendname1 = $participant->friendname1;
                    $friendsurname1 = $participant->friendsurname1;
                    $friendemail1 = $participant->friendemail1;
                    $friendtype1 = $participant->friendtype1;

                    $friendname2 = $participant->friendname2;
                    $friendsurname2 = $participant->friendsurname2;
                    $friendemail2 = $participant->friendemail2;
                    $friendtype2 = $participant->friendtype2;

                    $friendname3 = $participant->friendname3;
                    $friendsurname3 = $participant->friendsurname3;
                    $friendemail3 = $participant->friendemail3;
                    $friendtype3 = $participant->friendtype3;
