              ...
              <div class="widget-content widget-radius text-center bg-white">
                ...
                <div class="panel panel-danger">
                  ...
                  <div class="panel-body padding-30">
                    <?php echo $error;?>
                    <?php $css = $array = array('id' => 'uyekaydi', 'class' => 'form-horizontal');?>
                    <?php echo form_open_multipart('upload_controller/do_upload', $css); ?>
                    <!-- Üye Statu -->
                    <div class="form-group">
                    ...
                    <!-- Üye Soyismi -->
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Profil Fotoğrafı Ekle:</label>
                      <div class="col-sm-8">
                        <input type="file" class="form-control" name="userfile" size="20" />
                      </div>
                    </div>
                    <div class="text-right">
                      <button type="submit" name="submit" class="btn btn-danger center-block">Profili Güncelle</button>
                    </div>
                  </form>
                </div>
              </div>
