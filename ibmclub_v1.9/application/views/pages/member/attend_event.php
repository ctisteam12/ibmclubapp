  ...
  <div class="site-menubar">
    <div class="site-menubar-body">
          ...
          <div class="row" data-plugin="matchHeight" data-by-row="true">
            <div class="col-xlg-6 col-md-12">
              <div class="widget widget-shadow widget-responsive" id="widgetLineareaColor">
                <div class="widget-content widget-radius text-center bg-white">
                  ...
                  <div class="panel panel-success">
                    ...
                    <div class="panel-body padding-30">
                     ...
                     <?php echo form_open(''.$id, $css); ?>
                     <!--  <form class="form-horizontal" id="uyekaydi" autocomplete="off"> -->
                     <!-- Üye ismi -->
                     <div class="form-group">
                      <label class="col-sm-3 control-label" style="font-weight:bold">Etkinlik Adı:</label>
                      <div class="col-sm-9">
                    ...
                    <!-- Üye Soyismi -->
                    <div class="form-group">
                      <label class="col-sm-3 control-label" style="font-weight:bold">Etkinlik Tarihi:</label>
                      <div class="col-sm-9">
                       <?php echo $date ?>
                     </div>
                   </div>
                   <!-- Üye Email -->
                   <div class="form-group">
                    <label class="col-sm-3 control-label" style="font-weight:bold">Etkinlik Yeri:</label>
                    <div class="col-sm-9">
                     <?php echo $place ?>
                   </div>
                 </div>
                 <!-- Üye Puanı -->
                 <div class="form-group">
                  <label class="col-sm-3 control-label" style="font-weight:bold">Etkinlik Kotası:</label>
                  <div class="col-sm-9">
                   <?php echo $quota ?>
                 </div>
               </div>
               <!-- Üye Puanı -->
               <div class="form-group">
                <label class="col-sm-3 control-label" style="font-weight:bold">Etkinlik Puanı</label>
                <div class="col-sm-9">
                 <?php echo $point ?>
               </div>
             </div>
             <!-- Üye Puanı -->
             <div class="form-group">
              <label class="col-sm-3 control-label" style="font-weight:bold">Etkinlik İçeriği</label>
              <div class="col-sm-9">
     ...
     <div class="panel panel-primary">
      <header class="panel-heading">
        <div class="panel-actions"></div>
        <h3 class="panel-title">Katılımcı Bilgileri</h3>
      </header>
      <div class="panel-body padding-30">
       <!-- Üye ismi -->
       <form class="form-horizontal">
         <div class="form-group">
          <label class="col-sm-3 control-label" style="font-weight:bold">Üye Adı:</label>
          <div class="col-sm-9">
            <!--<input type="text" class="form-control" name="member_name" /> -->
        ...
        <!-- Üye Soyismi -->
        <div class="form-group">
          <label class="col-sm-3 control-label" style="font-weight:bold">Üye Soyadı:</label>
          <div class="col-sm-9">
       ...
       <!-- Üye Email -->
       <div class="form-group">
        <label class="col-sm-3 control-label" style="font-weight:bold">Üye Email:</label>
        <div class="col-sm-9">
     ...
     <!-- Katılımcı Sayısı -->
     <div class="form-group">
      <label class="col-sm-3 control-label" style="font-weight:bold">Diğer Katılımcı Sayısı:</label>
      <div class="col-sm-9 selectContainer">
        <select class="form-control" name="size" id="participant">
          <option value="null" selected="selected">Yanınızda katılacak kişi sayısını seçiniz</option>
  ...
  <?php $mid = $array = array('id' => 'uyekaydi', 'class' => 'form-horizontal');?>
  <?php echo form_open('member/attend?id='.$id, $mid); ?>
  <!-- Katılımcı sayısına göre döndürüyoruz-->
  <?php 
  for ($i=1; $i <= 3; $i++) { 
   ?>
   <div class="panel-body padding-30" style='display:none;' id='katilimci<?php echo $i; ?>'>
    <div class="panel panel-warning">
     <header class="panel-heading">
      <div class="panel-actions"></div>
      <h3 class="panel-title"><?php echo $i."." ?> Katılımcı Bilgileri</h3>
    </header>
    <!-- Katılımcı Adı -->
    <div class="form-group" class="panel-body padding-50">
      <label class="col-sm-3 control-label" style="font-weight:bold">Katılımcı Adı:</label>
      <div class="col-sm-9">
        <!--<input type="text" class="form-control" name="member_name" /> -->
        <input type="text" class="form-control" name="<?php echo "friendname".$i; ?>" placeholder="<?php echo $i."."." katılımcı ismi" ?>" />
      </div>
    </div>
    <!-- Katılmcı Soyismi -->
    <div class="form-group">
      <label class="col-sm-3 control-label" style="font-weight:bold">Katılımcı Soyadı:</label>
      <div class="col-sm-9">
       <input type="text" class="form-control" name="<?php echo "friendsurname".$i; ?>" placeholder="<?php echo $i."."." katılımcı soyismi" ?>" />
     </div>
   </div>
   <!-- Katılımcı Email -->
   <div class="form-group">
    <label class="col-sm-3 control-label" style="font-weight:bold">Katılımcı Email:</label>
    <div class="col-sm-9">
     <input type="text" class="form-control" name="<?php echo "friendemail".$i; ?>" placeholder="<?php echo $i."."." katılımcı email adresi" ?>" />
   </div>
 </div>
 <!-- Katılımcı Yakınlık -->
 <div class="form-group">
  <label class="col-sm-3 control-label" style="font-weight:bold">Katılımcı Yakınlığı:</label>
  <div class="col-sm-9">
   <input type="text" class="form-control" name="<?php echo "friendyakinlik".$i; ?>" placeholder="Örnek: Eş/Çocuk/Sevgili " />
 </div>
</div>
</div>
</div>
<!-- Php blogunu kapatıyoruz!-->
<?php
}
?>
<button type="submit" class="btn btn-primary" id="asdas">Katıl</button>
