...
<head>
  ...
  <!--[if lt IE 8]>
        ...
        <div class="page-content vertical-align-middle">
          ...
          <?php $id = $array = array('id' => 'uyekaydi', 'class' => 'form-horizontal');?>
          <?php echo form_open('pages/member_register', $id); ?>
          <div class="form-group">
            <label class="sr-only" for="name">Name</label>
            <input type="text" class="form-control" name="name" id="member_name" placeholder="İsim">
          </div>
          <div class="form-group">
            <label class="sr-only" for="surname">Surname</label>
            <input type="text" class="form-control" name="surname" id="member_surname" placeholder="Soyisim">
          </div>
          <div class="form-group">
            <label class="sr-only control-label" for="email">Email</label>
            <input type="email" class="form-control" name="email" id="member_email" placeholder="Email">
          </div>
          <div class="form-group">
            <label class="sr-only" for="password">Password</label>
            <input type="password" class="form-control" name="password" id="member_password" placeholder="Parola">
          </div>
          <button type="submit" class="btn btn-primary btn-block" id="create_member1">Kayıt Ol</button>
        </form>
      ...
      <footer class="page-copyright">
        <p>CTIS| TEAM 12</p>
        <p>© 2015-2016. All RIGHT RESERVED.</p>
      </footer>
