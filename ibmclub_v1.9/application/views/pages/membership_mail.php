    ...
    <head>
      ...
      <title>Üyelik Başvurunuz Kabul Edilmiştir.</title>
      <style type="text/css">
      body {
                        ...
                        <tr>
                          <td valign='top' align='center'>
                            <div class="contentEditableContainer contentTextEditable">
                              <div class="contentEditable">
                                <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#222222;'>IBM CLUB'a Hoş Geldiniz!</p>
                              </div>
                            </div>
                          </td>
                        </tr>
                          ...
                          <td align='left'>
                            <div class="contentEditableContainer contentTextEditable">
                              <div class="contentEditable" align='center'>
                               ...
                               <h2 >Sayın <?php echo $name." ".$surname.","; ?></h2>
                             </div>
                           </div>
                         </td>
                       </tr>
                          ...
                          <div class="contentEditableContainer contentTextEditable">
                            <div class="contentEditable" align='center'>
                              <p  style='text-align:left;color:#999999;font-size:14px;font-weight:normal;line-height:19px;'>
                               Üyelik Başvurunuz Kabul edilmiştir.<br>
                               Aşağıdaki üyelik bilgilerinizi kullanarak sisteme giriş yapabilirsiniz.
                               <br>
                               <br>
