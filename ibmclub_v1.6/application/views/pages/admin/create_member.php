                ...
                <div class="widget-content widget-radius text-center bg-white">
                  ...
                  <div class="panel panel-warning">
                    <div class="panel-heading">
                      <h3 class="panel-title">Üye Kaydı Oluştur</h3>
                    </div>
                    <div class="panel-body padding-30">
                     <?php $id = $array = array('id' => 'uyekaydi', 'class' => 'form-horizontal');?>
                     <?php echo form_open('member/create_member', $id); ?>
                    ...
                    <!-- Üye Soyismi -->
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Üye Soyadı</label>
                      <div class="col-sm-8">
                    ...
                    <!-- Üye Email -->
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Üye Email</label>
                      <div class="col-sm-8">
                    ...
                    <!-- Üye Parola -->
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Üye Parolası</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="member_password" />
                      </div>
                    </div>
                    <div class="text-right">
                      <button type="submit" class="btn btn-warning center-block" id="create_member1">Üye Kaydı Oluştur</button>
                    </div>
                  </form>
                </div>
              </div>
