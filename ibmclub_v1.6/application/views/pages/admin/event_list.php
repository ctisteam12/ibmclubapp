                     ...
                     foreach($events as $event){ 
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          $id = $event->event_id;
                          ?>
                          <a href="#"><button type="button" class="btn btn-danger btn-sm" data-target="#examplePositionSidebar" data-toggle="modal">Etkinliği İptal Et</button></a>
                        </td>
                      </tr> 
              ...
              <div class="modal-dialog modal-sidebar modal-sm">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p>Bu Etkinliği Kaldırmak istediğinizden Emin misiniz?</p>
                  </div>
                  <div class="modal-footer">
                   <a href="<?php echo site_url('events/cancel_event?id='.$id) ?>"><button type="button" class="btn btn-danger btn-block">Evet, Kaldır!</button></a>
