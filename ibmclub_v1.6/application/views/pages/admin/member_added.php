                ...
                <div class="widget-content widget-radius text-center bg-white">
                  ...
                  <div class="example example-popover">
                    ...
                    <div class="popover top">
                      <div class="arrow"></div>
                      <h3 class="popover-title">Üye Kayıt İşleminiz Tamamlanmıştır!</h3>
                      <div class="popover-content">
                        <p>Üye başarılı bir şekilde sisteme eklenmiştir! Yeni bir üye kaydı yapmak için sol ekranı kullanınız.</p>
                      </div>
                    </div>
                  </div>
                </div>
