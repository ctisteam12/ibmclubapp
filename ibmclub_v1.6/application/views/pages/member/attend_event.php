    ...
    <div class="page">
        ...
        <div class="row" data-plugin="matchHeight" data-by-row="true">
          <div class="col-xlg-6 col-md-12">
            <div class="widget widget-shadow widget-responsive" id="widgetLineareaColor">
             ...
             <!-- Üye Puanı -->
               <div class="form-group">
                <label class="col-sm-3 control-label">Etkinlik İçeriği</label>
                <div class="col-sm-9">
      ...
      <div class="panel panel-primary">
                  ...
                  <div class="panel-body padding-30">
                   ...
                   <!-- Üye ismi -->
                   <div class="form-group">
                    <label class="col-sm-3 control-label">Katılımcı Adı:</label>
                    <div class="col-sm-9">
                      <!--<input type="text" class="form-control" name="member_name" /> -->
                  ...
                  <!-- Üye Soyismi -->
                  <div class="form-group">
                    <label class="col-sm-3 control-label">Katılımcı Soyadı:</label>
                    <div class="col-sm-9">
                 ...
                 <!-- Üye Email -->
                 <div class="form-group">
                  <label class="col-sm-3 control-label">Katılımcı Email:</label>
                  <div class="col-sm-9">
